...
-- Last modification date: 2022-10-16 15:31:32.422
...
CREATE TABLE DIM_Product_Category (
    Category_ID int  NOT NULL,
    Name varchar(50)  NOT NULL,
    CONSTRAINT DIM_Product_Category_pk PRIMARY KEY  (Category_ID)
);
...
-- foreign keys
-- Reference: DIM_Product_DIM_Product_Category (table: DIM_Product)
ALTER TABLE DIM_Product ADD CONSTRAINT DIM_Product_DIM_Product_Category
